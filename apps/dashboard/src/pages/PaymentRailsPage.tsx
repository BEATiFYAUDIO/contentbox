  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-neutral-800 bg-neutral-950/40 p-4">
        <div className="text-base font-semibold">Node Payment Intake</div>
        <div className="text-sm text-neutral-400 mt-1">
          Your node processes payments and sends payouts. The wallet reflects available funds.
        </div>
        <div className="text-xs text-neutral-500 mt-1">
          Node and wallet show infrastructure state; participation and share are defined in Royalties.
        </div>
      </div>
